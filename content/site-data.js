...
window.NADIA_DATA = {
  ...
  home: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "Our days counted, one by one — with all our favorite moments saved forever. ♡",
  ...
  /* ---------------------------- ANNIVERSARY ----------------------------- */
  anniversary: {
    /* Love timer runs automatically from site.firstDay. Only the mini card text shows. */
    miniCard: {
      lines: [
    ...
    photos: [
      ...
      { src: "./assets/uploads/img_photobooth.jpg", alt: "Photo booth strip", caption: "booth strip memories" },
